...
import NavigationLink from "../sidebar/components/navigation-link";
const variants = {
	close: {
		x: -300,
		opacity: 0,
		...
		<motion.nav
			...
			<div className='flex flex-col gap-5'>
				...
				<a
					...
					<UserIcon className='p-1 w-8 rounded-full stroke-2 stroke-rose-800 bg-rose-200/70' />
					<p className='tracking-wide text-neutral-400 '>Steve Jobs</p>
				</a>
				<a
					href='#'
					className='flex flex-row gap-3 place-items-center'>
					<UserIcon className='p-1 w-8 rounded-full stroke-2 stroke-emerald-800 bg-emerald-200/70' />
					<p className='tracking-wide text-neutral-400 '>Bill Gates</p>
				</a>
				<a
					href='#'
					className='flex flex-row gap-3 place-items-center'>
					<UserIcon className='p-1 w-8 rounded-full stroke-2 stroke-indigo-800 bg-indigo-200/70' />
					<p className='tracking-wide text-neutral-400 '>Elon Musk</p>
				</a>
			</div>
		</motion.nav>
	);
