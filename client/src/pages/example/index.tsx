	...
	return (
		<div>
			<div className='mt-8 grid'>
				<button
					className='inline-flex mx-auto justify-center rounded-md bg-gray-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 sm:ml-3 '
					onClick={() => setOpen(!open)}
					style={{ "--overflow": "50" } as CSSProperties}>
					Toggle
				</button>
			</div>
