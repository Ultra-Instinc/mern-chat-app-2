...
export const LOGOUR_ROUTE = `${AUTH_ROUTES}/logout`;
...
export const MESSAGESS_ROUTES = "api/messages";

export const GET_MESSAGES = `${MESSAGESS_ROUTES}/get-messages`;
export const UPLOAD_FILE_ROUTE = `${MESSAGESS_ROUTES}/upload-file`;
